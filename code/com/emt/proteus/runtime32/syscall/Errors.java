...
/* 282 */   private static final Map<Integer, String> keys2names = Utils.createConstantMap(Errors.class);
/*     */   
/* 284 */   public static int syscall(int errorCode) { return -errorCode; }
/*     */   
/*     */   public static String toString(int error)
/*     */   {
/* 288 */     error &= 0x7FFFFFFF;
/* 289 */     return (String)keys2names.get(Integer.valueOf(error));
/*     */   }
/*     */ }


/* Location:              C:\Users\Joey\Downloads\codejar.jar!\com\emt\proteus\runtime32\syscall\Errors.class
